...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 7655.293; // -6846.850793455885 y position of the parallel encoder (in tick units)
        public double perpXTicks = -984.25; // x position of the perpendicular encoder (in tick units)
    }
