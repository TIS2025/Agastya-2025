...
//        });
        ...
        Action trajectoryAction = drive.actionBuilder(startPose)
                ...
                .waitSeconds(0.8)
//                .stopAndAdd(() -> new InstantAction(() -> new ShoulderCommand(shoulder, Shoulder.ShoulderState.DROP)))
...
//                .stopAndAdd(() -> new SpecInitSeq(intake, shoulder,elbow))
                ...
                .strafeToLinearHeading(new Vector2d(12,-46), Math.toRadians(90))
                ...
                .waitSeconds(0.5)
                .strafeToConstantHeading(new Vector2d(58,-42))
//                .strafeToLinearHeading(new Vector2d(50,-45), Math.toRadians(270))

                //todo slide 3rd sample
                .splineToLinearHeading((new Pose2d(65, -12, Math.toRadians(270))),Math.toRadians(0))
                .waitSeconds(0.5)
                .strafeToConstantHeading(new Vector2d(65,-60))
                .strafeToConstantHeading(new Vector2d(65,-40))
