...
public class Teleop_Blue extends LinearOpMode {
    ...
    public double strafe = 1, speed = 0.9, turn = 0.7, turnfull=0.9;
    ...
    public void runOpMode() {
        ...
        drive.setDrivePowers(
                new PoseVelocity2d(
                        ...
                        Math.pow(Range.clip(-gamepad1.right_stick_x * turnfull, -1, 1), 3))
        );
...
//            telemetry.addData("Power",Shoulder.power+Shoulder.ff);
            telemetry.addData("Specimen Mode", Globals.SpecimenMode);
            telemetry.addLine("---------------------------");
