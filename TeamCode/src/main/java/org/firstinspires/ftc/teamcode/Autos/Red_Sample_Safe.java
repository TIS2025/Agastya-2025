...
//        });
        ...
        TrajectoryActionBuilder trajectoryAction = drive.actionBuilder(startPose)
                ...
                .strafeToLinearHeading(new Vector2d(-56,-54), Math.toRadians(45))
...
//                .stopAndAdd(() ->new PreSamplePickSeq(intake, shoulder, elbow))
                ...
                .strafeToLinearHeading(new Vector2d(-19,-34), Math.toRadians(165))
...
//                .waitSeconds(0.5)
                ...
                //TODO Sample 1 Drop
                .stopAndAdd(() -> new PreSampleDropSeq(intake, shoulder,elbow))
                .strafeToLinearHeading(new Vector2d(-55,-52), Math.toRadians(45))
                .stopAndAdd(() -> new SampleDropSeq(intake, shoulder, elbow))
                .waitSeconds(0.4)
...
//                .stopAndAdd(() ->new PreSamplePickSeq(intake, shoulder, elbow))
                ...
                .strafeToLinearHeading(new Vector2d(-39,-35), Math.toRadians(162))
//                .stopAndAdd(() ->new PreSamplePickSeq(intake, shoulder, elbow))//RECALL
//
                .waitSeconds(0.5)
//                .stopAndAdd(() ->new SamplePickSeq(intake, elbow, shoulder))
//                .waitSeconds(0.5)
                ...
                .strafeToLinearHeading(new Vector2d(-42,-35), Math.toRadians(165),baseVelConstraint)
                .waitSeconds(0.2)  //0.3 seconds
                //TODO Sample 3 Drop
                .stopAndAdd(() -> new PreSampleDropSeq(intake, shoulder,elbow))
                .strafeToLinearHeading(new Vector2d(-55,-52), Math.toRadians(45))
                ...
                //.stopAndAdd(() -> new org.firstinspires.ftc.teamcode.auto_sequence.InitSeq(intake, shoulder, elbow)
